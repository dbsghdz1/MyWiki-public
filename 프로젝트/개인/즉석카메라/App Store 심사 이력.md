...
| — | 1.2 (5) | **출시됨** | 출시 시각 미기록 — 2026-09-23 `asc state` READY_FOR_SALE로 승인만 확인 |
| 2026-09-09 | 1.3 (6) | 제출 | 필름 선택을 팩에서 분리·핀치 줌(최대 5배)·스크린샷 재촬영 |
| **2026-09-10** | 1.3 (6) | **출시됨** | 09-09 21:09 UTC. KR·US 무료. 2026-09-23 iTunes lookup으로 확인 |
...
- 심사 연락처 4파일은 gitignore — 지워졌으면 재작성 (전화는 `+82 10-…` 국가코드 형식, 번호는 로컬 파일에만 둔다)
