...
| [[프로젝트/개인/WristNote/README|WristNote]] | 애플워치 회의 녹음→아이폰 온디바이스 전사·요약 앱(코드명) — **2026-08-31 착수**(홍 직접 지시), **09-01 v1 골격 완료**(워치 녹음·전송·전사·FoundationModels 요약·UI). 시뮬레이터 한계로 전송·전사는 실기기 M0 대기. 한국어 전사는 합성음 기준 품질 나쁨 — 실제 육성 재측정이 관문 | active |
