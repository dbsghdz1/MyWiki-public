...
| [[프로젝트/개인/한능검/README|한능검]] | 한국사능력검정시험 학습 앱 — **2026-08-26 착수 검토 시작, 아직 확정 아님**. 2027년 9급 공채 한국사가 한능검으로 대체돼 수요가 구조적으로 늘지만, 기출 문답지가 공공누리 4유형이지만 **저작권법 §24조의2로 문항 텍스트는 열릴 가능성이 높고, 진짜 벽은 문항에 실린 제3자 사진**이다 (08-26 재조사로 판정 정정). 스택 확정: **React+TS 코어 1벌 → 웹(Vercel) 먼저, Capacitor로 iOS·Android** | idea |
