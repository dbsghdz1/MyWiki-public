...
| [[프로젝트/개인/WristNote/README|WristNote]] | 애플워치 회의 녹음→아이폰 온디바이스 전사·요약 앱(코드명) — **2026-08-31 착수**(홍 직접 지시). 웨지는 Plaud($159 하드웨어)를 손목의 워치로 대체. make-or-break는 워치 백그라운드 녹음 지속(실기기 판정 대기) | active |
