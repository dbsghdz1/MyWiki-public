...
## 현재 카드
- **단계**: 운영
- **현재**: 1.0~1.1.3 출시(리젝 0회) · **1.1.4(build 6) 2026-09-20 제출 WAITING_FOR_REVIEW** — 주제 전면 제거 + 워치 타이머 「1초씩 안 올라간다」 대응 — [[프로젝트/개인/WristNote/App Store 심사 이력|심사 이력]]
- **다음 판정**: 1.1.4 심사 결과 + 실기기에서 워치 타이머가 매초 오르는지(첫 녹음 0:05 되감김 없음) 홍 확인
