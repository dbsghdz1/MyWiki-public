...
`index.md`는 의미 기반 진입점이고 `log.md`는 위키가 어떻게 변했는지 보여주는 append-only 감사 기록이다. [[_wiki/Sources/2026/07/2026-07-14-llm-wiki-사용자-요약|Karpathy LLM Wiki 사용자 요약]]
...
- 매 수집에서 영향 범위를 점검하고 30일마다 전체 lint를 수행한다.
