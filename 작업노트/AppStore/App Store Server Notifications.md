...
- 배운 것:
  - 알림 이력 API로 3건 확인: 08-08·08-10 `SUCCESS`, **08-18 23:03 ONE_TIME_CHARGE는 23:03·00:03 두 번 `UNSUCCESSFUL_HTTP_RESPONSE_CODE`** — 우리 웹훅이 404였기 때문([[작업노트/도구/Vercel 배포|Vercel 배포]]). 파이프라인 코드·Slack·ASC URL 등록은 전부 정상이었다.
