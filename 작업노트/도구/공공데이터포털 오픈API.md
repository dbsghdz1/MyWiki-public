...
- 맥락: [[프로젝트/개인/약국맵/README|약국맵]] [[프로젝트/개인/약국맵/실습 3-A — Fastify 프록시 2026-09-09|실습 3-A]]. 브라우저 직접 호출 → Fastify 프록시 경유로 전환
...
- 맥락: [[프로젝트/개인/약국맵/README|약국맵]] [[프로젝트/개인/약국맵/실습 1 — fetch와 useState 2026-09-08|실습 세션 1]]. 발급받은 서비스키로 첫 실호출
...
- 영향: 실습 1·2는 프록시 없이 확정. Fastify는 3번에서 **키 노출 + 캐싱** 때문에 붙인다
...
- 영향: 약국맵 실습 **세션 1·2를 프록시 없이 진행**할 수 있게 됐다. Fastify는 세션 3에서 **키를 감추고 FullData를 캐싱하려고** 붙인다 — 스택 선택은 유지, 근거만 좁아졌다.
