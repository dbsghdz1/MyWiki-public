...
- 맥락: [[프로젝트/개인/약국맵/README|약국맵]] [[프로젝트/개인/약국맵/사다리 2 — useEffect와 useQuery 2026-09-09|사다리 세션 2]]. 버튼 없이 자동 요청으로 바꾸며
- 배운 것:
...
- 맥락: [[프로젝트/개인/약국맵/README|약국맵]] [[프로젝트/개인/약국맵/사다리 1 — fetch와 useState 2026-09-08|사다리 세션 1]]. Vite 템플릿에서 시작해 "버튼 누르면 약국 XML을 화면에" 까지
- 배운 것:
